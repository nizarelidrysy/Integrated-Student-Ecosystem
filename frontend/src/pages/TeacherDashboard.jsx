      ...
      <div className="glass-panel">
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          <div style={{
            ...
            <img
              src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${demoUser?.first_name || 'Teacher'}&top=${demoUser?.gender === 'F' ? 'longHair,bob,curly' : 'shortFlat,shortRound,sides'}&mouth=smile&eyebrows=default&eyes=default`}
              alt="Profile"
